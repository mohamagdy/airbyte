...
from destination_singlestore.csv_writer import CSVWriter, CSV_EXTENSION, GZIP_EXTENSION
...
class TestCSVWriter(TestCase):
    ...
    @patch("destination_singlestore.csv_writer.NamedTemporaryFile")
    @patch("destination_singlestore.csv_writer.DictWriter")
    @patch("builtins.open")
    ...
    @patch("gzip.open")
    @patch("destination_singlestore.csv_writer.copyfileobj")
    ...
    @patch("destination_singlestore.csv_writer.Path")
